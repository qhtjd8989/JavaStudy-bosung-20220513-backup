...
public class Menu {
	...
	public static void javaMenu(char select, boolean loopFlag, Scanner scanner) {
	...
	public static void pythonMenu(char select, boolean loopFlag, Scanner scanner) {
	...
	public static void javascriptMenu(char select, boolean loopFlag, Scanner scanner) {
	...
	public static void main(String[] args) {
		...
		while(loopFlag) {
			...
			if(select == 'q') {
				...
				javaMenu(select, loopFlag, scanner);
				
			}else if (select == '2') {
				pythonMenu(select, loopFlag, scanner);
				
			}else if (select == '3') {
				javascriptMenu(select, loopFlag, scanner);
